...
This specification advances in lockstep with [unprotocols 1/C4](https://github.com/unprotocols/rfc). It will always be a cache of the C4 on unprotocols stable.
