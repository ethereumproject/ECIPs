...
### What is an ECIP?
    ...
    Author: Daniel Pittman <daniel.pittman@qwoyn.com>
    Created: 2018-07-27
	requires: ERC165
...
I was inspired by the ERC721 non-fungible token standard  authored by William Entriken <github.com@phor.net>, Dieter Shirley <dete@axiomzen.co>, Jacob Evans <jacob@dekz.net>, Nastassia Sachs <nastassia.sachs@protonmail.com>and would like to have the community accept it as an ethereum classic standard for all the same reasons as listed below.  

I have not removed anything this is the erc721 standard directly from ethereums eip.
